 ...
 * @author Chen Zen
 */
public class Choixrole extends javax.swing.JFrame {

    /**
     * Creates new form Choixrole
     */
    public Choixrole() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Choix du role");
        setResizable(false);
        setSize(new java.awt.Dimension(1343, 760));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setText("Sélectionnez votre Rôle");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/client.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/en-arriere.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LoginScreen login = new LoginScreen("Administrateur");
    login.setVisible(true);
    login.setLocationRelativeTo(null);
    this.dispose(); // ferme l'écran actuel
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        ProtocolSelection p = new ProtocolSelection();
         p.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Choixrole.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
